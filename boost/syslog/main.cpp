...
int main(int argc, char* argv[])
{
    try
    {
        ...
        shared_ptr< sinks::synchronous_sink< sinks::syslog_backend > > sink(new sinks::synchronous_sink< sinks::syslog_backend >(
	    boost::log::keywords::facility = sinks::syslog::user,               /*< the logging facility >*/
    	    boost::log::keywords::use_impl = sinks::syslog::native              /*< the native syslog API should be used >*/
	));
