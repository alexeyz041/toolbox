...
int main(int argc, char** argv)
{
	...
	if (argc < 2) {
	    openURL(*env, argv[0], "rtsp://127.0.0.1:8554/testStream");
	} else {
...
class Decoder1 : public Decoder {
public:
	Decoder1(int w,int h,Screen& s) : Decoder(w,h), s(s)
	{
	}
...
Decoder1 dec(WIDTH,HEIGHT,screen);
...
#define DUMMY_SINK_RECEIVE_BUFFER_SIZE (200000+32)
								...
								unsigned /*durationInMicroseconds*/)
{
  ...
  dec.decode(fReceiveBuffer,frameSize+4);
...
Boolean DummySink::continuePlaying()
{
  ...
  fSource->getNextFrame(fReceiveBuffer+4,
